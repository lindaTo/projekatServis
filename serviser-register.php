...
<html>
	...
	<body>
		<div class="container">
			...
			?>
				<div class="form-area">
					<form action="serviser-register-s.php" method="POST">
						<h1>REGISTRUJ NOVOG SERVISERA</h1>
						<input type="text" name="ime" value="" class="reg-user" placeholder="Ime" />
						<input type="text" name="prezime" value="" class="reg-user" placeholder="Prezime" />
						<input type="text" name="telefon" value="" class="reg-user" placeholder="Broj telefona" />
						<input type="text" name="email" value="" class="reg-user" placeholder="Email adresa" />
						<input type="text" name="radniSat" value="" class="reg-user" placeholder="Cena radnog sata u dinarima"/>
