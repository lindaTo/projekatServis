				...
				<?php
					...
					while($red=mysqli_fetch_array($result)) {
						...
						if($status == "Nepopravljeno"){
							echo "<td class='nep'><a href='kvar-status-ser.php?id=$id'>$status</a></td>";
						}else{
							echo "<td  class='pop'><a href='kvar-status2-ser.php?id=$id'>$status</a></td>";
						}
						echo "<td>$vreme h</td>";
						echo "<td>$cena RSD</td>";
						echo "<td><a href='kvar-delete.php?id=$id'><img src='slike/delete.png' /></a><a href='kvar-modify-ser.php?id=$id'><img src='slike/edit.png' /></a><a href='kvar-pregled-detaljno.php?id=$id'><img src='slike/info.png' /></td>";
					}
					echo "</tr>";
