		...
		<div class="container">
			...
			<div class="content">
				<?php
					...
					if($ime != "") {
						$qIme="UPDATE admini SET ime='$ime' WHERE id=$id;";
					...
					if($prezime != "") {
						$qPrezime="UPDATE admini SET prezime='$prezime' WHERE id=$id;";
					...
					if($telefon != "") {
						$qTelefon="UPDATE admini SET telefon='$telefon' WHERE id=$id;";
					...
					if($email != "") {
						$qEmail="UPDATE admini SET email='$email' WHERE id=$id;";
					...
					if($username != "") {
						$qUsername="UPDATE admini SET username='$username' WHERE id=$id;";
					...
					if($password != "") {
						$qPassword="UPDATE admini SET password='$password' WHERE id=$id;";
					...
					if($nastavak==false) {
						...
						echo "<a href='admin-modify.php'>Nazad</a></div>";
						exit;
					}
