	...
	<body>
		<div class="container">
			...
			<?php
				...
				$query = "DELETE FROM serviseri WHERE id=$id;";

				$result = mysqli_query($conn, $query);
				
				if($result) {
					echo "<div class='uspesno'><p>Uspesno ste obrisali servisera.</p><br/>";
					echo "<a href='serviser-pregled.php'>Pregled servisera</a></div>";
					exit;
				}else {
					echo "<div class='greska'><p>Greska pri brisanju!</p><br/>";
					echo "<a href='serviser-pregled.php'>Nazad</a></div>";
					exit;
				}
