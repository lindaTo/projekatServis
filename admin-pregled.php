		...
		<div class="container">
			...
			<div class="content">
				<?php
					...
					echo "<h1 class='naslov' align='center'>Pregled registrovanih administratora</h1>";
					
					echo "<table><tr class='tdhead'><td>ID</td><td>Ime</td><td>Prezime</td><td>Telefon</td><td>Email</td><td>Username</td><td>Radnje</td></tr>";
					...
					while($red=mysqli_fetch_array($result)) {
						...
						echo "<td>$email</td>";
						echo "<td>$username</td>";
						echo "<td><a href='admin-delete.php?id=$id'><img src='slike/delete.png' /></a><a href='admin-modify.php?id=$id'><img src='slike/edit.png' /></td>";
					}
					echo "</tr>";
